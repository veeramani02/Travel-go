...
import "../../Styles/AdminBookTrip.css";
import API_BASE_URL from "../../config/api";
import CustomizedSnackbars from "../../Components/CustomizedSnackbars";

function BookTrip({ Open, Close }) {
    ...
    try {
      ...
      if (
        ...
        tripEstimatedDuration = Number(
          (routeData.routes[0].duration / 3600).toFixed(2),
        );

        tripEstimatedDistance = Number(
  ...
  return (
    <div className="bt-booktrip-page">
      <form className="bt-booktrip-form" onSubmit={handleSubmit} noValidate>
        <h1 className="bt-booktrip-title">
          Plan Your <span>Journey</span>
        </h1>

        <div className="bt-booktrip-group">
          <label>Name</label>
